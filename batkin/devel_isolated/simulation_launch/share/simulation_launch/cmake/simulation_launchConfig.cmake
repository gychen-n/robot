...
if("TRUE" STREQUAL "TRUE")
  set(simulation_launch_SOURCE_PREFIX /home/robot/batkin/src/launch/simulation_launch)
  set(simulation_launch_DEVEL_PREFIX /home/robot/batkin/devel_isolated/simulation_launch)
  ...
  set(simulation_launch_INSTALL_PREFIX /home/robot/batkin/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'simulation_launch' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/batkin/src/launch/simulation_launch/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT simulation_launch_NUM_DUMMY_TARGETS)
      set(simulation_launch_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::simulation_launch::wrapped-linker-option${simulation_launch_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR simulation_launch_NUM_DUMMY_TARGETS "${simulation_launch_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::simulation_launch::wrapped-linker-option${simulation_launch_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND simulation_launch_LIBRARIES "${interface_target_name}")

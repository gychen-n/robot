...
if("TRUE" STREQUAL "TRUE")
  set(no_enemy_app_SOURCE_PREFIX /home/robot/batkin/src/no_enemy_app)
  set(no_enemy_app_DEVEL_PREFIX /home/robot/batkin/devel_isolated/no_enemy_app)
  ...
  set(no_enemy_app_INSTALL_PREFIX /home/robot/batkin/install_isolated)
...
if(NOT "/home/robot/batkin/src/no_enemy_app/include " STREQUAL " ")
  set(no_enemy_app_INCLUDE_DIRS "")
  set(_include_dirs "/home/robot/batkin/src/no_enemy_app/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'no_enemy_app' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/batkin/src/no_enemy_app/${idir}'.  ${_report}")
    endif()

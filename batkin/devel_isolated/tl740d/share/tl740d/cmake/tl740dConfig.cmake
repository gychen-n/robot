...
if(NOT "/home/robot/batkin/src/imu/tl740d/include " STREQUAL " ")
  set(tl740d_INCLUDE_DIRS "")
  set(_include_dirs "/home/robot/batkin/src/imu/tl740d/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tl740d' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/batkin/src/imu/tl740d/${idir}'.  ${_report}")
    endif()

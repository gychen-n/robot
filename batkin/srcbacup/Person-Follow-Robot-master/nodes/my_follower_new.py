...
class Follower():
    def __init__(self):
        ...
        self.depth_subscriber = rospy.Subscriber('/kinect2/sd/points', PointCloud2, self.set_cmd_vel, queue_size=1)

        rospy.loginfo("Subscribing to point cloud...")
        
        # Wait for the pointcloud topic to become available
        rospy.wait_for_message('/kinect2/sd/points', PointCloud2)
    ...
    def set_cmd_vel(self, msg):
        ...
        for point in point_cloud2.read_points(msg, skip_nans=True):
            ...
            if -pt_y > self.min_y and -pt_y < self.max_y and pt_x < self.max_x and pt_x > self.min_x and pt_z < self.max_z and pt_z > self.min_z:
                x += pt_x
                y += pt_y
                z += pt_z
                n += 1

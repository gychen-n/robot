...
static bool upload_on = true; 	//true-上传热词；false-不上传热词
...
static int upload_userwords()
{
	...
	fp = fopen("/home/robot/xfyun/userwords.txt", "rb");
	if (NULL == fp)										
	{
...
void on_speech_begin()
{
	...
	{
		std::stringstream ss;
		ss << "aplay -q /home/robot/batkin/src/xfyun_waterplus/sound/on.wav"; //16khz,单声道
		system(ss.str().c_str());
	}
}
...
int main(int argc, char* argv[])
{
	...
	int ret = MSP_SUCCESS;
	const char* login_params = "appid = 5cd90a8a, work_dir = .";
